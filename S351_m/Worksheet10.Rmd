...
3. Suppose that about $13 \%$ of the population is left-handed. A 200-seat auditorium has been built with 15 "lefty seats," seats that have the built-in desk on the left rather than the right arm of the chair. In a class of 90 students, what's the probability that there will not be enough seats for the left-handed students?
...
5. In 200 tosses of a fair coin:
...
> d. What is the probability that we have less than 95 heads? (Use continuity correction factor)
