...
>> It won't change since the width of confidence interval only depends on confidence level and sample size. So the confidence interval will only **shift** when we change the sample mean.
...
> The 80% CI: $\bar{x} \pm t_{\alpha_2}\frac{s}{\sqrt n}= 16 \pm 1.289\times \frac{1}{\sqrt{121}}= (15.88, 16.12)$.

> The 98% CI: $\bar{x} \pm t_{\alpha_2}\frac{s}{\sqrt n}= 16 \pm 2.358\times \frac{1}{\sqrt{121}}= (15.79, 16.21)$.
...
>> If we know the true proportion $\frac{x}{N}$ of smokers is between $(0.2128,0.3798)$ then number of smokers among 150 people is $150 \times$ (0.2128, 0.3798)= (31.92, 56.97). But since we are the **number** of smokers, this should be an integer. We need to round it to (31, 57).  
