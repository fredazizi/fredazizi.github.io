...
7. The number of flaws in an optic fiber cable follows a Poisson Distribution. The average number of flaws in $50 \mathrm{~m}$ is $1.5$. Let $x=$  number of  flaws in $50 \mathrm{~m}$.
